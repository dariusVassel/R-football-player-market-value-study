---
title: "Football Player Market Value Study"
author: "Samarth"
output:
...
The graph (Overall x ValueEUR) above shows that the Overall of a player causes a huge impact on their market value. Players with a overall of 70 are cheap but it is also evident that some better overall players have a lower market value while having a similar skill level. Apart from a players overall skill level what   influences on players market price?
...
#OBSERVATION 
The graph (Age x ValueEUR) above shows that a majority of players see a decline in market value post 25 with a significant decline occurring post 30.

Market Value decline shows the risk appetite for clubs interested in older players lets see what relationship is observed in overall skill level vs age.
...
#The correlation coefficient for Overall and ValueEUR  is 0.5580

#The correlation coefficient for Age and ValueEUR  is 0.03713
